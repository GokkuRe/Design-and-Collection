...
#define CUSTOM_MACHINE_NAME "DUAL_SINGLENOZZLE"
...
// Ultimaker               // là loại máy in hình hộp và có kết cấu vững chắc nhất
...
// Mendel Parts V9 on 12V // mendel là loại máy in 3d có hai trục z, đa phần sử dụng loại này
...
/**
  ...
  Sau khi nhập số bước/mm vào chương trình điều khiển ở trên và nạp vào mạch điều khiển, bạn đọc có thể cho máy chạy theo các trục X, Y, Z hoặc tời nhựa in và hiệu chỉnh lại số bước/mm như sau:

  Bước 1: Điều khiển máy di chuyển theo trục (sợi nhựa) cần hiệu chỉnh một đoạn H (khoảng 40mm trở lên, càng dài càng tốt). Cách điều khiển thủ công bạn đọc xem tại (Hướng dẫn sử dụng Repetier Host hoặc Sử dụng GRBL 0.9 trên Arduino CNC Shield v3).
  Bước 2: Sau khi di chuyển, sử dụng thước kẹp (không được sử dụng thước dây hay thước kẻ vì không đủ chính xác, bạn đọc có thể dễ dàng tìm mua thước kẹp tại các tiệm hoặc chợ cơ khí) để đo quãng đường dịch chuyển thực tế I trên trục tương ứng.
  Bước 3:Tính lại số bước/mm thực tế: TT = LT*H/I
  Bước 4: Nhập lại số bước/mm TT vào chương trình điều khiển và thử lại vài lần tới khi đạt yêu cầu.

*/
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 80, 80, 400, 101.4} //92.5  đối với động cơ đùn trực tiếp không có bánh răng
